        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="item in itemDetail.spuSaleAttrList" :key="item.id">
                ...
                <dd
                  ...
                  @click="chooseAttr(item2, item.spuSaleAttrValueList)"
                >
...
export default {
  ...
  mounted() {
    this.$store.dispatch("detail/getItemDetail", this.$route.params.skuId);
  },
};
</script>
